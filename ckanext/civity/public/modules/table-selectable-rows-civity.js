/* modify original 'table-selectable-rows' <input type="checkbox" ...>  to resolve accessibility violation
 */
this.ckan.module('table-selectable-rows-civity', function($) {
	return {
		...
		initialize: function() {
			...
			this.select_all = $('<span class="sr-only">Select all rows</span><input type="checkbox" aria-label="Select all rows">')
